...
@Slf4j
public class ReactiveSolrMessageHandler extends AbstractReactiveMessageHandler {
    private final S3AsyncClient s3client;
    private final String bucketName;

    public ReactiveSolrMessageHandler(S3AsyncClient s3client, String bucketName) {
