...
@Slf4j
public class ReactiveMongoBulkMessageHandler extends AbstractReactiveMessageHandler {
    private final S3AsyncClient s3client;
    private final String bucketName;

    public ReactiveMongoBulkMessageHandler(S3AsyncClient s3client, String bucketName) {
