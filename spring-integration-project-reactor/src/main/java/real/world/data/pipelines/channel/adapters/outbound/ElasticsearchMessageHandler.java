...
//
//@Slf4j
//public class ElasticsearchMessageHandler extends AbstractReactiveMessageHandler {
//    private final S3AsyncClient s3client;
//    private Expression bucketNameExpression;
//    private boolean expectReply;
//
//    public ElasticsearchMessageHandler(S3AsyncClient s3client, Expression bucketName) {
//        this.s3client = s3client;
//        this.bucketNameExpression = bucketName;
//    }
//
//    public ElasticsearchMessageHandler(S3AsyncClient s3client) {
//        this.s3client = s3client;
//    }
//
//    /**
