...
//
//@Slf4j
//public class LuceneMessageHandler extends AbstractReactiveMessageHandler {
//    private final S3AsyncClient s3client;
//    private Expression bucketNameExpression;
//    private boolean expectReply;
//
//    public LuceneMessageHandler(S3AsyncClient s3client, Expression bucketName) {
//        this.s3client = s3client;
//        this.bucketNameExpression = bucketName;
//    }
//
//    public LuceneMessageHandler(S3AsyncClient s3client) {
//        this.s3client = s3client;
//    }
//
//    /**
