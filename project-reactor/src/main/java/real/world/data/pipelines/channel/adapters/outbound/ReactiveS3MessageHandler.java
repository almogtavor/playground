package real.world.data.pipelines.channel.adapters.outbound;
...
@Slf4j
public class ReactiveS3MessageHandler implements ReactiveMessageHandler {
    ...
    public Mono<Message<String>> handleMessageInternal(Message<String> message) {
        ...
        return Mono.fromFuture(future).then(Mono.just(message));
    }
